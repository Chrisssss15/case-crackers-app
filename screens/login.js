...
// Login scherm waar de gebruiker een e-mailadres kan invullen
export default function Login({ setCurrentScreen }) {
  const [email, setEmail] = useState(""); // Houdt het ingevulde e-mailadres bij

  // Functie voor de knop "Ga verder"
  const goNext = () => {
    if (email === "") {
      Alert.alert("Let op", "Vul eerst je e-mailadres in.");
      return;
    }
    ...
    Alert.alert(
      ...
      "Je bent succesvol ingeschreven voor nieuwsbrieven en updates.",
      [
        {
          text: "OK",
          onPress: () => {
            setCurrentScreen("homescreen");
            console.log("Gaat naar de homescreen na aanmelden");
          },
        },
      ]
    );
  ...
  // Functie om het aanmelden over te slaan
  const skip = () => {
    setCurrentScreen("homescreen");
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <View style={styles.inputBox}>
            ...
            {/* Knop om het invoerveld leeg te maken */}
            {email !== "" && (
              <TouchableOpacity
                onPress={() => setEmail("")}
          ...
          {/* Knop om aanmelden over te slaan */}
